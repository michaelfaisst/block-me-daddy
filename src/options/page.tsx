        ...
        <>
            <div className="container pt-6 md:pt-12">
                ...
                <p className="scroll-m-20 text-sm md:text-base text-gray-500 dark:text-gray-400 mb-8 md:mb-12">
                    Block sites like youtube, facebook, instagram and all the
            ...
            <Tabs defaultValue="settings" className="mb-12 md:mb-16">
                <TabsList variant="underline" className="mb-6">
                    <div className="container">
                        ...
                        <TabsTrigger variant="underline" value="statistics">
                            Statistics
                        </TabsTrigger>
                    </div>
                </TabsList>
            ...
            <div className="container">
                <footer className="mt-12 md:mt-16 pt-6 md:pt-8 pb-6 md:pb-12 border-t">
